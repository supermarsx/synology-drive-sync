(function exposeReleaseSelectorData(root, factory) {
    ...
    return Object.freeze({
        ...
        archiveSources: Object.freeze([
            ...
            Object.freeze({ minor: 4, build: "7.4-90075", url: "https://archive.synology.com/download/Os/DSM/7.4-90075" }),
        ]),
        ...
        compatibilityGroups: [
            ...
            },
            {
                ...
                minMinor: 4,
                maxMinor: 4,
                models: ["DS1525neo+", "DS1825neo+", "DS725neo+", "DS925neo+", "FS200T", "FS3420", "FS6420", "RS1226+", "RS1226RP+", "RS1626xs+", "RS2423RP+II", "RS3626xs", "RS4826xs+", "RS6426xs+", "RS826+", "RS826RP+"],
            },
            {
