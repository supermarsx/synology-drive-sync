...
- [Synology DSM package](synology-package.md)
  - [Dashboard and navigation](dsm/dashboard.md)
  - [Compatibility and release selection](dsm/compatibility.md)
  - [Install, ACLs, and lifecycle](dsm/install-lifecycle.md)
  - [Profiles and destinations](dsm/profiles.md)
    - [Secrets and protected values](dsm/secrets.md)
  - [Routines and scheduling](dsm/routines.md)
  - [Health, activity, logs, and notifications](dsm/operations.md)
  - [Dashboard security model](dsm/security.md)
  - [CLI parity and private paths](dsm/cli-parity.md)
  - [Troubleshooting and live-NAS acceptance](dsm/troubleshooting.md)
  - [Build and validate SPKs](dsm/package-development.md)
